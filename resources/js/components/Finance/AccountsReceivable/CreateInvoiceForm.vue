<template>
    <div class="space-y-6">
        <form @submit.prevent="submit" class="space-y-6">
            <!-- Basic Information -->
            <div class="space-y-4">
                <h3 class="text-lg font-medium text-card-foreground">Basic Information</h3>
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-4">
                    <div v-for="(item, index) in form.items" :key="`item-${index}`"
                        ...
                        <div class="space-y-3">
                            <Label :for="`item_name_${index}`" class="text-sm font-medium">Item Name
                                *</Label>
                        ...
                        <div class="space-y-3">
                            <Label :for="`product_id_${index}`" class="text-sm font-medium">Product
                                (Optional)</Label>
                        ...
                        <div class="flex space-x-3">
                            <div class="flex-1 space-y-3">
                                <Label :for="`unit_price_${index}`" class="text-sm font-medium">Unit Price
                                    *</Label>
                        ...
                        <div class="md:col-span-4 grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-border">
                            ...
                            <div class="space-y-3">
                                <Label :for="`tax_rate_${index}`" class="text-sm font-medium">Tax Rate
                                    (%)</Label>
                            ...
                            <div class="space-y-3">
                                <Label :for="`discount_rate_${index}`" class="text-sm font-medium">Discount
                                    Rate (%)</Label>
