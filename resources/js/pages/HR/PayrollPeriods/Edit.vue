    ...
    <div class="container mx-auto p-6">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-white">Edit Payroll Period</h1>
                    <p class="text-white mt-2">Update payroll period details</p>
                </div>
            </div>
                ...
                <form @submit.prevent="handleSubmit" class="space-y-6">
                    ...
                    <div class="flex justify-end gap-4 pt-6 border-t">
                        ...
                        <Button type="submit" :disabled="submitting" class="flex items-center gap-2">
                            ...
                            {{ submitting ? 'Updating...' : 'Update Payroll Period' }}
                        </Button>
                    </div>
                </form>
            </div>
...
import { ArrowLeft, Save, Loader2, CreditCard } from 'lucide-vue-next'
import { apiService } from '@/services/api'
import type { PayrollPeriod, PayrollPeriodForm } from '@/types/erp'
...
const handleSubmit = async () => {
    ...
    try {
        ...
        // Submit form
        await apiService.updatePayrollPeriod(props.id, form.value)
