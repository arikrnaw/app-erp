    ...
    <div class="container mx-auto p-6">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 class="text-3xl font-bold text-white">Edit Employee</h1>
            <p class="text-white mt-2">Update employee information</p>
          </div>
        </div>
...
import { ArrowLeft, Save, Loader2, Users } from 'lucide-vue-next'
import { apiService } from '@/services/api'
import type { Employee, EmployeeForm, Department, Position } from '@/types/erp'
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // Submit form
    await apiService.updateEmployee(props.id, form.value)
