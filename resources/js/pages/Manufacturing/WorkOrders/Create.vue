...
import type { Product, ProductionPlan, BillOfMaterial, WorkCenter, Warehouse, User } from '@/types/erp';
...
const generateNumber = async () => {
    ...
    try {
        const response = await apiService.generateWorkOrderNumber();
        form.value.work_order_number = response.work_order_number;
    } catch (error) {
...
const handleSubmit = async () => {
    ...
    try {
        ...
        await apiService.createWorkOrder(submitData);
