...
import type { Product, InventoryTransaction } from '@/types/erp'
...
const form = useForm<InventoryTransactionForm>({
    ...
    reference_type: props.transaction.reference_type || '',
    reference_id: props.transaction.reference_id || '',
...
const submit = (): void => {
    form.put(route('inventory.update', props.transaction.id))
}
