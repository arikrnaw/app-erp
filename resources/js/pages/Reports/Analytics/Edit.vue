<template>
    ...
    <Head title="Edit Business Analytics" />
    <AppLayout>
        <template #header>
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight">Edit Business Analytics</h1>
                    <p class="text-muted-foreground">
                        Update the business analytics report: {{ analytics.title }}
                    </p>
                </div>
                <Link :href="route('reports.analytics.show', analytics.id)">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Update the details below to modify your business analytics report.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex items-center justify-end gap-4 pt-6">
                            ...
                            <Button type="submit" :disabled="form.processing">
                                ...
                                {{ form.processing ? 'Updating...' : 'Update Analytics' }}
                            </Button>
                        </div>
                    </form>
                </CardContent>
...
const form = useForm({
    ...
    analysis_type: props.analytics.analysis_type,
    data_source: props.analytics.data_source,
    analysis_date: props.analytics.analysis_date,
    data_start_date: props.analytics.data_start_date || '',
    data_end_date: props.analytics.data_end_date || '',
    key_metrics: props.analytics.key_metrics,
    insights: props.analytics.insights,
    recommendations: props.analytics.recommendations,
    visualization_data: props.analytics.visualization_data,
    priority: props.analytics.priority,
    status: props.analytics.status,
});

const submit = () => {
    form.put(route('reports.analytics.update', props.analytics.id), {
        onSuccess: () => {
            // Handle success
        },
    });
...
const breadcrumbs = [
    ...
    { name: props.analytics.title, href: route('reports.analytics.show', props.analytics.id) },
    { name: 'Edit Analytics', href: '#' },
];
</script>
