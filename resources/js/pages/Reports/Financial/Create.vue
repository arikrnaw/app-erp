...
const submit = () => {
    form.post(route('reports.financial.store'), {
        onSuccess: () => {
            // Handle success
        },
    });
...
const breadcrumbs = [
    ...
    { title: 'Create Report', href: '/reports/financial/create' },
];
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold tracking-tight">Create Financial Report</h1>
                    <p class="text-muted-foreground">
                        Generate a new comprehensive financial report
                    </p>
                </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Enter the basic details for your financial report
                        </CardDescription>
                    </CardHeader>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Enter the financial figures for your report
                        </CardDescription>
                    </CardHeader>
                    <CardContent class="space-y-4">
                        <div class="grid gap-4 md:grid-cols-2">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Preview of your financial report
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div class="space-y-4">
