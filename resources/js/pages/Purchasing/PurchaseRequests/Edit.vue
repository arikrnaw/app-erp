                        ...
                        <form v-else @submit.prevent="submitForm" class="space-y-6">
                            ...
                            <div class="border-t pt-6">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="space-x-2">
                                        <Button type="button" @click="saveDraft" variant="outline"
                                            :disabled="submitting">
...
import { ArrowLeft, Plus, Trash2, Save, Send, Loader2 } from 'lucide-vue-next'
import { apiService } from '@/services/api'
import type { PurchaseRequest, PurchaseRequestItem, Product, Department } from '@/types/erp'
...
const fetchRequest = async () => {
    ...
    try {
        ...
        form.value = {
            ...
            request_date: response.request_date ? new Date(response.request_date).toISOString().split('T')[0] : '',
            required_date: response.required_date ? new Date(response.required_date).toISOString().split('T')[0] : '',
...
const submitForm = async () => {
    ...
    try {
        ...
        await apiService.updatePurchaseRequest(props.id, requestData)
        router.visit(route('purchasing.purchase-requests.show', props.id))
    } catch (error) {
